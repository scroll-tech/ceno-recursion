...
use crate::{custom_dense_mlpoly::DensePolynomialPqx, math::Math, scalar::SpartanExtensionField};
...
impl<S: SpartanExtensionField> SumcheckInstanceProof<S> {
        ...
        F: Fn(&S, &S, &S) -> S,
    {
        ...
        (SumcheckInstanceProof::new(cubic_polys), r, vec![
        ...
        F: Fn(&S, &S, &S) -> S,
    {
      ...
      */
      ...
      polys.push(poly.compress());
        ...
        (SumcheckInstanceProof::new(polys), r, vec![
            poly_A[0],
